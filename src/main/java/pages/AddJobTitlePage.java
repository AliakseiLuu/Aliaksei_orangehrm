...
public class AddJobTitlePage extends BasePage {
    ...
    private final By jobTitleField = By.xpath("//form/div/div/div/input[@class='oxd-input oxd-input--active']");
    private final By jobDescriptionField = By.xpath("//div/textarea[@placeholder='Type description here']");
    ...
    public AddJobTitlePage(WebDriver driverParam) {
        super(driverParam);
    }
